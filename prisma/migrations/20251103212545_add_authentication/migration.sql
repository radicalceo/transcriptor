...
VALUES ('00000000-0000-0000-0000-000000000000', 'Default User', 'default@transcriptor.local', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- AlterTable - Add userId column as nullable first
ALTER TABLE "Meeting" ADD COLUMN "userId" TEXT;

-- Update existing meetings to use the default user
UPDATE "Meeting" SET "userId" = '00000000-0000-0000-0000-000000000000' WHERE "userId" IS NULL;

-- Make userId NOT NULL now that all rows have a value
