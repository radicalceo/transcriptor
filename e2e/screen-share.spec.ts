...
test.describe('Page Meeting Screen-Share', () => {
  ...
  // Note: Le modal de sélection audio n'est pas encore implémenté pour screen-share
  // TODO: Ajouter les tests du modal quand il sera implémenté

  test('affiche la transcription en cours', async ({ page, context }) => {
    await context.grantPermissions(['microphone'])

    // Mock pour avoir une transcription
    await page.route('**/api/screen-share/test-screen-share-id', async (route) => {
        ...
        await route.fulfill({
          ...
          body: JSON.stringify({
            ...
            meeting: {
              ...
              type: 'screen-share',
              status: 'active',
              audioMode: 'mic-only', // Pour ne pas afficher le sélecteur
    ...
    await page.goto('/meeting/screen-share/test-screen-share-id')
